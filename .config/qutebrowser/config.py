...
config.bind('<F9>', 'mode-enter passthrough', mode='normal')
config.bind('<F9>', 'mode-enter passthrough', mode='insert')
config.bind('<F9>', 'mode-enter normal', mode='passthrough')
#
config.bind('<F1>', 'mode-enter passthrough', mode='normal')
config.bind('<F1>', 'mode-enter passthrough', mode='insert')
config.bind('<F1>', 'mode-enter normal', mode='passthrough')
...
config.bind('zb', 'spawn --userscript qute-bitwarden --auto-lock 999999 ')
config.set('qt.args', ['disable-features=HardwareMediaKeyHandling'])
