...
let g:fzf_force_include_dirs = "plugged/ autoload/"
let $FZF_DEFAULT_COMMAND = "rg --files --hidden --glob '!.git/**' --glob '!build/**' --glob '!.dart_tool/**' --glob '!.idea' --glob '!node_modules' " . g:fzf_force_include_dirs
...
" super rg: recursively search for a string
function! RipgrepFzf(query, fullscreen)
